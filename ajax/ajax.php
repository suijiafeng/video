...
ini_set('error_log', dirname(__FILE__) . '/error_log.txt');  
    ...
    switch($type){
    	case 'video':
                ...
                echo '<li class="col-xs-6 col-sm-6   col-md-3 col-lg-3" ><a href="./watch.php?v='.$v["id"]["videoId"].'" target="_black" class="hhh" title="'.$v["snippet"]["title"].'" >
    ...
    echo '<li class="col-xs-6 col-sm-6 col-md-3 col-lg-3" ><a href="./watch.php?v='. $value['id'].'" class="hhh" >
    ...
    echo '<li class="col-xs-6 col-sm-6 col-md-3 col-lg-3" ><a href="./watch.php?v='. $v["id"].'" class="hhh" >
...
';
  ...
  <p class="mb-0">本站使用cookies临时存储您的历史记录在您的浏览器上，本站不会对您的观看历史进行保存，仅记录您的最后30条浏览记录，若您清理过你的浏览器cookies，将无法恢复！</p>
    ...
    echo '<li class="col-xs-6 col-sm-6   col-md-3 col-lg-3" ><a href="./watch.php?v='. $v['id']['videoId'].'" class="hhh" >
